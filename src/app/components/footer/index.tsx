   ...
   <FooterContainer>
     ...
     <InnerContainer>
       <AboutContainer>
         ...
         <AboutText>
           Yourcar is a Car renting and selling company located in many countries across the world
...
const BottomContainer = styled.div`
  ${tw`w-full max-w-screen-2xl flex justify-center md:justify-start mt-7 md:mt-1`};
`;
...
const AboutContainer = styled.div`
  ${tw`flex flex-col mr-2 md:mr-16 pl-10 pr-10 md:pl-3 md:pr-3`};
`;

const AboutText = styled.p`
  ${tw`text-white text-sm font-normal max-w-xs leading-5 mt-2`};
`;

const SectionContainer = styled.div`
  ${tw`w-full md:w-auto
    flex flex-col
    mr-2 md:mr-16 pl-10 pr-10 md:pl-3 md:pr-3 mt-7 md:mt-0`};
`;

const LinksList = styled.ul`
  ${tw`outline-none list-none flex flex-col`};
`;
...
const RedIcon = styled.span`
  ${tw`
    w-9 h-9 rounded-full bg-red-500
